...
//     global.LegolandMenu = mod.exports;
//   }
...
//   var LegolandMenu = function ($) {

//     var NAME = 'LegolandMenu';
//     var DATA_KEY = 'LegolandMenu';
...
//     var LegolandMenu = function () {
//       function LegolandMenu(element, config) {
//         _classCallCheck(this, LegolandMenu);
...
//             if (!data) {
//               data = new LegolandMenu(this, _config);
...
//     $.fn[NAME] = LegolandMenu._jQueryInterface;
//     $.fn[NAME].Constructor = LegolandMenu;
//     $.fn[NAME].noConflict = function () {
//       $.fn[NAME] = JQUERY_NO_CONFLICT;
//       return LegolandMenu._jQueryInterface;
//     };
//     return LegolandMenu;
//   }(jQuery);
// });
...
;(function (window, factory) {
  if (typeof define === "function" && define.amd) {
    ...
    window.LegolandMenu = mod.exports;
  }
})(this, function ($) {
    $.fn.extend({ 
        LegolandMenu: function (options) { 
             // 合并参数，通过“extend”合并默认参数和自定义参数
            args = $.extend({}, defaults, options);  
            this.each(function() { 
                $(this).find('li>a').bind('click',function(){
                    console.log($(this),$(this).attr('class'),'class');
                    if($(item).attr('class').indexOf(args.openClass)>=0){
                        close($(item));
                    }
                    else{
                        open($(item));
    ...
    function close(target){
        target.removeClass(args.openClass);
    }
    function open(target){
        target.addClass(args.openClass);
    }
})
